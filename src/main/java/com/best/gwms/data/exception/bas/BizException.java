 ...
 */
public class BizException extends RuntimeException implements com.best.xingng.org.apache.cxf.exception.CheckedException {
    protected static final Log logger = LogFactory.getLog(BizException.class);
    ...
    public BizException(String code, String... values) {
        super(code);
